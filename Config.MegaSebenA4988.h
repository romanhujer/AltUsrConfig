...
#define MegaSebenA4988_OFF   //  <- Turn _ON to use this configuration
...
#define MaxRate                   72 // microseconds per microstep default setting for gotos, can be adjusted for two times lower or higher at run-time
...
#define BacklashTakeupRate        25 // backlash takeup rate (in multipules of the sidereal rate): too fast and your motors will stall,
                                     ...
                                     // Axis1 is for RA/Az
#define StepsPerDegreeAxis1  10910.1176470588   // for 16uSteps
//#define StepsPerDegreeAxis1  21820.2352941177  // for 32uSteps
                                     // calculated as    :  stepper_steps * micro_steps * gear_reduction1 * (gear_reduction2/360)
                                     // NEMA17 + PLANET   :  200 * 16 * (1+46/17)*60/25 * 138/360 = 10910.11765
 
                                     // Axis2 is for Dec/Alt
#define StepsPerDegreeAxis2  9728.0   // for 16uSteps
//#define StepsPerDegreeAxis2 19456.0  // for 32uSteps
                                     // calculated as    :  stepper_steps * micro_steps * gear_reduction1 * (gear_reduction2/360)
                                     // NEMA17 + PLANET   :  200 * 16 * (1+46/11)*60/25 * 88/360 = 9728.0
                                     
                                     // PEC, number of steps for a complete worm rotation (in RA), (StepsPerDegreeAxis1*360)/gear_reduction2.  Ignored on Alt/Azm mounts.
#define StepsPerWormRotationAxis1 28461L // for 16uSteps            
//#define StepsPerWormRotationAxis1 56922L // for 32uSteps            
                                     //  NEMA17 + PLANET         : (10910.11765*360)/138 = 28461  

//#define PECBufferSize         626  // Min
...
#define AXIS1_DRIVER_MODEL A4988      // Axis1 (RA/Azm):  Default _OFF, Stepper driver model (see above)
...
#define AXIS2_DRIVER_MODEL A4988      // Axis2 (Dec/Alt): Default _OFF, Stepper driver model (see above)
